...
class InScreenSecurity extends StatefulWidget {
  const InScreenSecurity({super.key});

  @override
  State<InScreenSecurity> createState() => _InScreenSecurityState();
}

class _InScreenSecurityState extends State<InScreenSecurity> {
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          Get.to(InChalanDetails(outScreenController
                              .inScreenChalanList[index].id
                              .toString()));
                        },
                        child: Container(
