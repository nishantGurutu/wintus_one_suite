...
class InScreenDepartment extends StatefulWidget {
  const InScreenDepartment({super.key});

  @override
  State<InScreenDepartment> createState() => _InScreenDepartmentState();
}

class _InScreenDepartmentState extends State<InScreenDepartment> {
