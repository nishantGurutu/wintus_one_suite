...
class _LeadListState extends State<LeadList> {
  ...
  Future<void> apiCalling() async {
    ...
    leadController.isUploadedDocumentLeadSelected.value = false;
        ...
        child: RefreshIndicator(
          ...
          child: rxFilteredList2.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    print(
                        'ytr656 yd6567 76tr76 $index ${rxFilteredList2[index].leadNumber} ${rxFilteredList2[index].documentUploadStatus}');
                    return Padding(
                      padding: EdgeInsets.symmetric(vertical: 5.h),
                      child: GestureDetector(
                        onTap: () {
                                ...
                                Obx(() => rxFilteredList2[index]
                                    ...
                                    ? Container(
                                        ...
                                        child: Padding(
                                          padding: EdgeInsets.all(8.sp),
                                          child: Text(
                                            "✅ Document successfully uploaded by ${rxFilteredList2[index].ownerName ?? ""}, waiting for your manager approval.",
                                            style: TextStyle(
                                                fontSize: 11.sp,
                                                color: Color(0xff434343)),
                                          ),
                                        ...
                                        : rxFilteredList2[index]
                                            ...
                                            ? Container(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsets.all(8.sp),
                                                  child: Text(
                                                    "✅ Document approvel pending from CMO.",
                                                    style: TextStyle(
                                                        fontSize: 11.sp,
                                                        color:
                                                            Color(0xff434343)),
                                                ...
                                                ? Container(
                                                    ...
                                                    child: Padding(
                                                      padding:
                                                          EdgeInsets.all(8.sp),
                                                      child: Text(
                                                        "✅ Document successfully approved by CEO.",
                                                        style: TextStyle(
                                                            fontSize: 11.sp,
                                                            color: Color(
                                                                0xff434343)),
  ...
  Widget _statusContainer(String text) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
        color: Color(0xffE5FFF9),
      ...
      child: Padding(
        ...
        child: Text(
          text,
          style: TextStyle(fontSize: 11, color: Color(0xff434343)),
        ),
      ),
    );
  }
