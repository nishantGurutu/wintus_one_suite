...
class _SelectContactState extends State<SelectContact> {
  ...
  Future<void> _fetchData() async {
    try {
      ...
      errorMessage.value = 'Failed to load contacts. Please try again.';
    }
  }

  void _updateFilteredList() {
    final searchText = searchAssignController.text.toLowerCase();
    filteredList.value = taskController.responsiblePersonList
        .where((person) =>
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Scaffold(
        ...
        body: SafeArea(
          child: taskController.isResponsiblePersonLoading.value
                  ...
                  : Column(
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            Get.to(
                                NewGroup(taskController.responsiblePersonList));
                          },
                          child: Padding(
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              filled: true,
                              labelStyle:
                                  TextStyle(color: searchBackgroundColor),
                              counterText: "",
