...
class WorkOrderPdfDocumentApprove extends StatefulWidget {
  ...
  State<WorkOrderPdfDocumentApprove> createState() =>
      _WorkOrderPdfDocumentApproveState();
}

class _WorkOrderPdfDocumentApproveState
    extends State<WorkOrderPdfDocumentApprove> {
